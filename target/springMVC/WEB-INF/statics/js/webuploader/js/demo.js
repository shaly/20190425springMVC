jQuery(function() {
    ...
    uploader = WebUploader.create({
		...
		fileVal:"file1",
        chunked: true,
         server: 'http://localhost:8080/springMVC/uploadFile3',
    ...
    function updateStatus() {
        ...
        if ( state === 'ready' ) {
            ...
            if ( stats.uploadFailNum ) {
                text = 'already upload ' + stats.successNum+ ' number picture to XX picture box,'+
                    stats.uploadFailNum + 'number upload filed ，<a class="retry" href="#">upload again</a>filed picture or <a class="ignore" href="#">ignore</a>'
            }
            ...
            if ( stats.uploadFailNum ) {
                text += ', failed upload ' + stats.uploadFailNum + ' numbers';
            }
        }
    ...
    function setState( val ) {
        ...
        switch ( state ) {
            ...
            case 'confirm':
                $progress.hide();
                $upload.text( 'start to  upload' ).addClass( 'disabled' );
